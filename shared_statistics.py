...
# Based on https://github.com/andrewliao11/pytorch-a3c-mujoco
class SharedRMSprop(optim.Optimizer):
    """Implements RMSprop algorithm with shared statistics.
    """
...
class SharedAdam(optim.Optimizer):
    """Implements Adam algorithm with shared statistics.
    """
